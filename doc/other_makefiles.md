...
A makefile separating source and binary that can be executed from the source tree:
```makefile
SOURCE_DIR:=/test/source_dir/examples/separate-binaries
BINARY_DIR:=/test/binary_dir/mp3_player_out
...
include_dirs := $(BINARY_DIRS)/lib lib include
